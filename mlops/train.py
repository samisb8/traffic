...
def generate_casablanca_traffic_data():
    ...
    print(f"⚡ Heures de pointe détectées: {(model_df['traffic_level'] > 0.8).sum()} cas")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Entraînement modèle trafic Casablanca")
    parser.add_argument("--test-mode", action="store_true", help="Mode test (rapide)")
    parser.add_argument("--regenerate", action="store_true", help="Forcer régénération données")
